...
<select name="Vaga" class="form-control" required>
	<option value="">Escolha...</option>
	<option value="Berçario 1"<?php if($aluno['Vaga']=="Berçario 1") echo "selected";?>>Berçario 1 - nascidos de 01/07/2017 a 31/08/2017</option>
	<option value="Berçario 2"<?php if($aluno['Vaga']=="Berçario 2") echo "selected";?>>Berçario 2 - 01 ano - nascidos de 01/07/2016 a 30/06/2017</option>
	<option value="Maternal 1"<?php if($aluno['Vaga']=="Maternal 1") echo "selected";?>>Maternal 1 - 02 anos - nascidos de 01/07/2015 a 30/06/2016</option>
	<option value="Maternal 2"<?php if($aluno['Vaga']=="Maternal 2") echo "selected";?>>Maternal 2 - 03 anos - nascidos de 01/07/2014 a 30/06/2015</option>
	<option value="1º Período"<?php if($aluno['Vaga']=="1º Período") echo "selected";?>>1º Período 2 - 04 anos - nascidos de 01/07/2013 a 30/06/2014</option>
	<option value="2º Período"<?php if($aluno['Vaga']=="2º Período") echo "selected";?>>2º Período 2 - 05 anos - nascidos de 01/07/2012 a 30/06/2013</option>
</select>
</div>
</div>
...
<div class="row">
	...
	<input type="text" name="Nascimento" value="<?php echo $aluno['Nascimento']?>" class="form-control" onkeyup="dataConta(this);" minlength="10" maxlength="10" required onkeypress='return SomenteNumero(event)'>	
	</div>
...
<div class="row">
	<div class="col-md-8"><label>A familia é beneficiária do Programa Bolsa Família?</label>
		Sim:<input type="radio" required onclick="document.getElementById('Num_Cartao').disabled=false;" name="Bolsa_Familia" value="Sim"<?php if($aluno['Bolsa_Familia']=="Sim") echo "checked";?>>
		Não:<input type="radio" name="Bolsa_Familia" onclick="document.getElementById('Num_Cartao').disabled=true;" value="Não"<?php if($aluno['Bolsa_Familia']=="Não") echo "checked";?>>
	</div>
	<div class="col-md-4">
		<label>Nº do cartão:</label><input type="text" name="Num_Cartao" id="Num_Cartao" class="form-control" value="<?php echo $aluno['Num_Cartao']?>" disabled>
	</div>
</div>

<div class="row">	
	<div class="col-md-12"><label>Renda Familiar:</label>
		<input type="radio" name="Renda" required value="Até 1 salário mínimo"<?php if($aluno['Renda']=="Até 1 salário mínimo") echo "checked";?>>Até 1 salário mínimo 
		<input type="radio" name="Renda" value="Até 2 salários mínimos"<?php if($aluno['Renda']=="Até 2 salários mínimos") echo "checked";?>>Até 2 salários mínimos
		<input type="radio" name="Renda" value="2 a 4 salários mínimos"<?php if($aluno['Renda']=="2 a 4 salários mínimos")?>>2 a 4 salários mínimos
		<input type="radio" name="Renda" value="Acima de 4 salários mínimos"<?php if($aluno['Renda']=="Acima de 4 salários mínimos") echo "checked";?>>Acima de 4 salários mínimos
	</div>
</div>
...
<div class="row">
	<div class="col-md-4">
		...
		<input type="radio" name="Resp_Trabalha" required value="Sim"<?php if($aluno['Resp_Trabalha']=="Sim") echo "checked";?>>Sim
		<input type="radio" name="Resp_Trabalha" value="Não"<?php if($aluno['Resp_Trabalha']=="Não") echo "checked";?>>Não
	</div>
	<div class="col-md-8">
		<label>Moradia:</label>
		<input type="radio" name="Moradia" required value="Própria"<?php if($aluno['Moradia']=="Própria") echo "checked";?>>Própria
		<input type="radio" name="Moradia" value="Alugada"<?php if($aluno['Moradia']=="Alugada") echo "checked";?>>Alugada
		<input type="radio" name="Moradia" value="Cedida"<?php if($aluno['Moradia']=="Cedida") echo "checked";?>>Cedida
	</div>
</div>-->
